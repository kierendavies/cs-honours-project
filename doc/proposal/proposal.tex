...
We plan to use both Prot{'e}g{'e'}\footnote{http://protege.stanford.edu/} and the TDDonto tool\footnote{https://semantic.cs.put.poznan.pl/wiki/aristoteles/doku.php} for this project. Prot{'e}g{'e'} was developed at Stanford University and is a free and open source tool for ontology editing and framework for building intelligent systems. This requires no license to use. TDDonto is a plugin for Prot{'e}g{'e'} made available online. It is not open source but is available for use. Verbal permission was given by Dr C. M. Keet, co-creator of the tool and the supervisor for this project, to use the software.
