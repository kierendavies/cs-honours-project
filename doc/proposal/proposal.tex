...
\todo[Ameerah: Is this section necessary; possibly - an abstract was specifically called for but not an introduction. It may be that the following section suffices as an intro though needs to be spruced up]

\section{Project Description}

\subsection{Project Background}

\todo[Ameerah: Which part of the broader problem do you intend to address?]
